...
const gridcontent = [
  ...
  {
    imgSrc: "https://ahaanmedia.com/ahaanwebsite/Industry/grids-image1.webp", // Updated consistent path style
...
const RealEstate = () => {
  return (
    <div className="ecommerce-section container-fluid p-0">
      ...
      <img 
        src="https://ahaanmedia.com/ahaanwebsite/Industry/RealEstate.webp" 
