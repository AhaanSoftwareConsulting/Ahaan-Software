...
const gridcontent = [
  {
    imgSrc: "https://ahaanmedia.com/ahaanwebsite/Industry/SocialMediaPlatformDevelopment.webp",
  ...
  {
    imgSrc: "https://ahaanmedia.com/ahaanwebsite/Industry/ContentModeration&Compliance.webp",
  ...
  {
    imgSrc: "https://ahaanmedia.com/ahaanwebsite/Industry/User-Engagement.webp",
  ...
  {
    imgSrc: "https://ahaanmedia.com/ahaanwebsite/Industry/DataSecurity&PrivacyProtection.webp",
...
const Social = () => {
  return (
    <div className="ecommerce-section container-fluid p-0">
      ...
      <img 
        src="https://ahaanmedia.com/ahaanwebsite/Industry/SocialNetworking.webp" 
        alt="Social Networking" 
        className="img-fluid content-image mb-4" 
      />
