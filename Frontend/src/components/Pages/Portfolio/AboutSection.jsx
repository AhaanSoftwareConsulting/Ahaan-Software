          ...
          <div className="col-lg-6 mb-5 mb-lg-0">
            <div className="about-images">
              <div className="main-image">
                <img src="https://ahaanmedia.com/ahaanwebsite/All/team1.webp" alt="Team" className="img-fluid" />
              </div>
              <div className="overlap-image">
                <img src="https://ahaanmedia.com/ahaanwebsite/All/team2.webp" alt="Team Working" className="img-fluid" />
              </div>
          ...
          24/7 Support <span className="divider"></span>
            ...
            <div className="about-bottom d-flex align-items-center flex-wrap gap-3">
              ...
              <div className="about-contact d-flex align-items-center">
                <img src="https://ahaanmedia.com/ahaanwebsite/All/blog-dp.webp" alt="Support" />
                <div>
            ...
            <div className="video-modal-content">
              ...
              <div className="video-wrapper">
                <video width="100%" height="400" controls autoPlay>
                  <source src="https://ahaanmedia.com/ahaanwebsite/video/about-video.mp4" type="video/mp4" />
