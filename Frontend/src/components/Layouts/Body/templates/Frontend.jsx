  ...
  return (
    <div className="multi-cube-wrapper">
      ...
      <div className="laptop-center">
        <img src="https://ahaanmedia.com/ahaanwebsite/All/laptop.webp" alt="Laptop" className="laptop-image" />
      </div>
      {/* Modal */}
      {selectedCube && (
