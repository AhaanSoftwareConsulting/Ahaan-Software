...
const Backend = () => {
  ...
  const [selectedCube, setSelectedCube] = useState(null);
    ...
    const cubePositions = [
        { className: "cube15", icon: "https://ahaanmedia.com/ahaanwebsite/technology/Node.webp", heading: "Node", heading2: "JS", color: "#5BAF4A", heading3: "Node Js", description: "Node.js is a JavaScript runtime built on Chrome's V8 engine, enabling server-side development. It allows developers to use JavaScript for both front-end and back-end, offering fast, scalable applications, especially for real-time, data-intensive services like APIs and web servers." },
        { className: "cube16", icon: "https://ahaanmedia.com/ahaanwebsite/technology/Python.webp", heading: "Python", heading2: "Python", color: "#336C99",  heading3: "Python", description: "Python is a versatile, high-level programming language known for its readability and simplicity. It supports multiple programming paradigms and is widely used in web development, data science, automation, machine learning, and scripting, making it ideal for both beginners and professionals." },
        { className: "cube17", icon: "https://ahaanmedia.com/ahaanwebsite/technology/Mysql.webp", heading: "Mysql", heading2: "Mysql", color: "#CC9338",  heading3: "MySql", description: "MySQL is an open-source relational database management system (RDBMS) used for storing and managing structured data. It uses SQL queries for data manipulation and is widely used in web applications, offering scalability, reliability, and robust performance for various projects." },
        { className: "cube18", icon: "https://ahaanmedia.com/ahaanwebsite/technology/Mongodb.webp", heading: "Mongo", heading2: "DB", color: "#489C3A",  heading3: "Mongo DB", description: "MongoDB is a NoSQL, document-based database designed for handling large volumes of unstructured or semi-structured data. It stores data in flexible, JSON-like documents, offering scalability, high performance, and ease of use for modern applications and real-time analytics." },
        { className: "cube19", icon: "https://ahaanmedia.com/ahaanwebsite/technology/Express.webp", heading: "Express", heading2: "JS", color: "#1C3A62",  heading3: "Express JS", description: "Express.js is a lightweight, flexible Node.js web application framework. It simplifies routing, middleware management, and HTTP request handling, making it easier to build scalable, fast, and maintainable server-side applications, particularly for APIs and RESTful services."},
        { className: "cube20", icon: "https://ahaanmedia.com/ahaanwebsite/technology/Php.webp", heading: "Php", heading2: "Php", color: "#8892BD",  heading3: "Php", description: "PHP is a server-side scripting language used for web development, enabling dynamic content generation. It is widely used to create interactive websites, handle forms, and interact with databases. PHP is embedded within HTML and offers extensive frameworks for rapid development." },
      ];
