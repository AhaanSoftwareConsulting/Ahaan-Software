...
const Devops = () => {
  ...
  const [selectedCube, setSelectedCube] = useState(null);
    ...
    const cubePositions = [
        { className: "cube27", icon: "https://ahaanmedia.com/ahaanwebsite/technology/Hostinger.webp", heading: "Hosti", heading2: "Nger", color: "#673EE5", heading3: "Hostinger", description: "Hostinger is a web hosting provider offering affordable, high-performance hosting solutions, including shared, VPS, and cloud hosting. It provides fast loading times, excellent customer support, and an easy-to-use interface, making it ideal for both beginners and experienced website owners." },
        { className: "cube28", icon: "https://ahaanmedia.com/ahaanwebsite/technology/AWS.webp", heading: "AWS", heading2: "AWS", color: "#FD9801", heading3: "AWS", description: "Amazon Web Services (AWS) is a cloud computing platform offering a wide range of services, including computing power, storage, databases, machine learning, and analytics. It helps businesses scale, innovate, and manage infrastructure efficiently with flexible, pay-as-you-go pricing." },
        { className: "cube29", icon: "https://ahaanmedia.com/ahaanwebsite/technology/Kuberneties.webp", heading: "Kuber", heading2: "Neties", color: "#326CE4", heading3: "Kuberneties", description: "Kubernetes is an open-source container orchestration platform that automates the deployment, scaling, and management of containerized applications. It ensures high availability, load balancing, and efficient resource management, making it ideal for managing complex, distributed systems in cloud environments." },
        { className: "cube30", icon: "https://ahaanmedia.com/ahaanwebsite/technology/Docker.webp", heading: "Docker", heading2: "Docker", color: "#2F7081", heading3: "Docker", description: "Docker is an open-source platform that automates the deployment, scaling, and management of applications within lightweight, portable containers. It enables consistent environments across development, testing, and production, streamlining workflows and improving application performance and scalability." },
        { className: "cube31", icon: "https://ahaanmedia.com/ahaanwebsite/technology/GCP.webp", heading: "GCP", heading2: "GCP", color: "#D34237", heading3: "GCP", description: "Google Cloud Platform (GCP) is a suite of cloud computing services offering infrastructure, data storage, machine learning, and analytics tools. It enables businesses to build, deploy, and scale applications with high performance, security, and reliability on Google's global infrastructure." },
        { className: "cube32", icon: "https://ahaanmedia.com/ahaanwebsite/technology/Plesk.webp", heading: "Plesk", heading2: "Plesk", color: "#50B3E2", heading3: "Plesk", description: "Plesk is a web hosting control panel that simplifies website and server management. It offers a user-friendly interface for managing domains, email accounts, databases, and security, making it easy for web professionals to automate tasks and streamline hosting operations." },
      ];
