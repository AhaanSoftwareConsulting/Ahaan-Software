...
const gridcontent = [
  {
    imgSrc: "https://ahaanmedia.com/ahaanwebsite/Industry/CorporateLearningSolutions.webp",
  ...
  {
    imgSrc: "https://ahaanmedia.com/ahaanwebsite/Industry/EducationtoCareerSolutions.webp",
  ...
  {
    imgSrc: "https://ahaanmedia.com/ahaanwebsite/Industry/ProfessionalUpskillingPrograms.webp",
...
const Education = () => {
  return (
    <div className="ecommerce-section container-fluid p-0">
      ...
      <img 
        src="https://ahaanmedia.com/ahaanwebsite/Industry/Education.webp" 
